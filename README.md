...
```bash
cd <projeto>      # ex: youtube-clone
npm install
npm run dev
```

Cada projeto é independente. Os clones (Next.js) buildam com `npm run build`; o Batman Tickets é estático.

---

_Mais projetos chegando. Construído com foco em qualidade de acabamento e decisões de arquitetura justificadas._
